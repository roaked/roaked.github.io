...
My foundational roots in computer science instanced in me a deep curiosity in modern computing, particularly in the branches of (stochastic) optimization coupled with machine learning. My interests span from adaptive systems & safe learning to probabilistic reasoning using Bayesian beliefs to address uncertainty, unpredictability and overconfidence in intelligent decision-making within real‑world engineering challenges, specifically those in advanced manufacturing, robotics, autonomous vehicles and drone technology.
