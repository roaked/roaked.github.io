...
My foundational roots in computer science drove my exploration into modern computing, particularly focusing on intelligent systems and the interplay with machine learning. AI models possess significant capabilities, yet they frequently exhibit overconfidence. They behave poorly at estimating uncertainty in their predictions and often are unable to say ‘I don’t know’ in response to an unfamiliar situation. My interests concern probabilistic machine learning to address this uncertainty and overconfidence in decision-making within real-world engineer applications, specifically those in advanced manufacturing, robotics and autonomous vehicles where an incorrect prediction can lead to catastrophic consequences.
