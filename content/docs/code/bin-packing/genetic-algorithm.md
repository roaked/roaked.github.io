...
{{< hint tip >}}
[Implementation of PSO](https://ricardochin.com/docs/code/bin-packing/particle-swarm-optimization/)

[Comparison between GA and PSO](https://ricardochin.com/docs/code/bin-packing/#5-ending-thoughts){{< /hint >}}
